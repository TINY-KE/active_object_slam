...
public:
    ...
    cv::Mat GrabImageRGBD(const cv::Mat &imRGB,const cv::Mat &imD, const double &timestamp, const std::vector<BoxSE> & bbox);
...
protected:
    ...
    void UpdateLastFrame_fortrackmotion();
...
//[active slam]
public:
    void CreatObject_intrackmotion();
